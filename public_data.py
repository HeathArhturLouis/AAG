...
if __name__ == "__main__":
    ...
    assert(Sym_5.operation([4, 0, 1, 2, 3],
                           [1, 2, 3, 4, 0]) == Sym_5.Id)

    assert(Sym_5.canonise(pd.gamma_1(a, b))
           == Sym_5.canonise(Word([[1, 2, 3, 4, 0],
                                   [1, 2, 3, 4, 0]],
                                  [False, False])))

    assert(Sym_5.canonise(pd.gamma_2(a, b))
           == Sym_5.operation([4, 0, 1, 2, 3],
                              [4, 0, 1, 2, 3]))
